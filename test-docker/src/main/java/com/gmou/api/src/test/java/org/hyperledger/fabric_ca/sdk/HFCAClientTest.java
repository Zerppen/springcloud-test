...
import com.gmou.api.src.test.java.org.hyperledger.fabric.sdkintegration.SampleStore;
import com.gmou.api.src.test.java.org.hyperledger.fabric.sdkintegration.SampleUser;
...
//        cryptoSuite.init();
    ...
    public void testEnrollmentNoKeyPair() throws Exception {
        ...
        //
//        CryptoSuite cryptoPrimitives = CryptoPrimitives.Factory.getCryptoSuite();
...
//        client.setCryptoSuite(cryptoPrimitives);
...
//    }
    ...
    public void testRevoke1NullUser() throws Exception {
        ...
        HFCAClient client = HFCAClient.createNewInstance("client", "http://localhost:99", null);
        KeyPair keypair = crypto.keyGen();
        Enrollment enrollment = new com.gmou.api.src.test.java.org.hyperledger.fabric_ca.sdk.HFCAEnrollment(keypair, "abc");
